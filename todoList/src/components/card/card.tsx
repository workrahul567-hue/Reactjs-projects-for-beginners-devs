    ...
    <ul className="list-group w-full">
      <li className="list-group-item py-2 px-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
        ...
        <div className="flex items-center">
          <button className="ml-2 text-yellow-500 hover:text-yellow-600" title="Mark as done">
          ...
          <button className="ml-2 text-red-500 hover:text-red-600" title="Delete task">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
...
{
  /* <div classNameName="w-48 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
